    ...
    <div class="container px-4 mx-auto overflow-hidden">
                            ...
                            <tr class="" style=" background: gray; ">
                                ...
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Mobile No</span>
                                    </div>
                                </td>

                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Status Details</span>
                                    </div>
                                </td>

                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Status Code</span>
                                    </div>
                                </td>
        ...
        <div class="flex flex-wrap -mx-4 items-center justify-between">
            ...
            <div class="w-full lg:w-auto px-4 flex items-center justify-center">
                <div class="row">
                    <div class="col-md-12">
                        {{ $response_logs->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
