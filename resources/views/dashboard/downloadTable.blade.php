    ...
    <div class="container px-4 mx-auto overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <div class="inline-block min-w-full overflow-hidden">
                    <table class="table-auto w-full">
                            ...
                            <tr class="" style=" background: gray; ">
                                ...
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Message</span>
                                    </div>
                                </td>

                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Joined</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Status</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                                        <span class="text-sm font-heading font-semibold uppercase">Purchased</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5 h-20 min-w-max border-b ">
                        ...
                        <tbody>
                            @foreach ($downloaded_msg as $msg)
                            <tr>
                                <td class="p-0">
                                    <div class="flex items-center pl-11 h-20 min-w-max border-b border-gray-100">
                                        <span class="font-heading font-medium">{{ $msg->sl }}</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div
                                        class="flex items-center justify-start p-5 h-20 min-w-max border-b border-gray-100">
                                ...
                                <td class="p-0">
                                    <div
                                        ...
                                        <span
                                            class="text-darkBlueGray-400 font-heading">{{ $msg->mobile_number }}</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div
                                ...
                                <td class="p-0">
                                    <div
                                        class="flex items-center justify-center p-5 h-20 min-w-max border-b border-gray-100">
                                        <span class="text-darkBlueGray-400 font-heading">Monthly subscription</span>
                                    </div>
                                </td>
                                <td class="p-0">
                                    <div
        ...
        <div class="flex flex-wrap -mx-4 items-center justify-between">
            ...
            <div class="w-full lg:w-auto px-4 flex items-center justify-center">
                <div class="row">
                    <div class="col-md-12">
                        {{ $downloaded_msg->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
